...
local p = {
	...
	fg = "{{ foreground }}",
	muted = "{{ color8 }}",
	subtle = "{{ color8 | lighten(0.2) }}",

	-- Surfaces (graduated from background)
	surface0 = "{{ background | darken(0.03) }}",
	surface1 = "{{ background | lighten(0.03) }}",
	surface2 = "{{ background | lighten(0.06) }}",
	surface3 = "{{ background | lighten(0.09) }}",
	surface4 = "{{ background | lighten(0.12) }}",

	-- Borders
	overlay = "{{ color8 | darken(0.15) }}",
	...
	string = "{{ color14 | lighten(0.2) }}",

	-- Types: steel blue
	type = "{{ color10 | darken(0.1) }}",
	...
	operator = "{{ color8 | lighten(0.1) }}",

	-- Preprocessor, macros, annotations: navy-light
	macro = "{{ color6 | lighten(0.2) }}",

	-- ── UI accent colors ──
	accent = "{{ color9 }}",
	accent2 = "{{ color10 }}",
	red = "{{ color3 | lighten(0.3) }}",

	-- Tonal: primary (purple shades)
	primary_5 = "{{ color0 | darken(0.02) }}",
	primary_40 = "{{ color1 }}",
	primary_50 = "{{ color1 | lighten(0.1) }}",
	primary_60 = "{{ color9 }}",
	primary_70 = "{{ color9 | lighten(0.1) }}",

	-- Tonal: secondary (blue shades)
	secondary_50 = "{{ color6 }}",
	secondary_60 = "{{ color14 }}",
	secondary_70 = "{{ color14 | lighten(0.1) }}",

	-- Tonal: tertiary (blue-magenta shades)
	tertiary_30 = "{{ color2 | darken(0.1) }}",
	tertiary_40 = "{{ color2 }}",
	tertiary_50 = "{{ color10 | darken(0.1) }}",
	tertiary_60 = "{{ color10 }}",
	tertiary_70 = "{{ color10 | lighten(0.1) }}",

	-- Tonal: error (magenta/red shades)
	error_10 = "{{ color3 | darken(0.2) }}",
	error_30 = "{{ color3 | darken(0.1) }}",
	error_40 = "{{ color3 }}",
	error_50 = "{{ color3 | lighten(0.1) }}",
	error_60 = "{{ color11 }}",
	error_70 = "{{ color11 | lighten(0.1) }}",

	-- Tonal: neutral
	neutral_10 = "{{ color0 }}",
	neutral_40 = "{{ color8 | darken(0.1) }}",
	neutral_50 = "{{ color8 }}",
	neutral_60 = "{{ color8 | lighten(0.1) }}",
	neutral_70 = "{{ color8 | lighten(0.2) }}",
	neutral_80 = "{{ color7 }}",
}
...
vim.g.terminal_color_1 = "{{ color3 }}"
vim.g.terminal_color_2 = "{{ color10 }}"
vim.g.terminal_color_3 = "{{ color11 }}"
vim.g.terminal_color_4 = "{{ color9 }}"
vim.g.terminal_color_5 = "{{ color1 }}"
vim.g.terminal_color_6 = "{{ color14 }}"
vim.g.terminal_color_7 = "{{ foreground }}"
vim.g.terminal_color_8 = "{{ color0 | lighten(0.3) }}"
vim.g.terminal_color_9 = "{{ color3 | lighten(0.3) }}"
vim.g.terminal_color_10 = "{{ color10 | lighten(0.3) }}"
vim.g.terminal_color_11 = "{{ color11 | lighten(0.3) }}"
vim.g.terminal_color_12 = "{{ color9 | lighten(0.3) }}"
vim.g.terminal_color_13 = "{{ color1 | lighten(0.3) }}"
vim.g.terminal_color_14 = "{{ color14 | lighten(0.3) }}"
vim.g.terminal_color_15 = "{{ foreground | lighten(0.3) }}"
