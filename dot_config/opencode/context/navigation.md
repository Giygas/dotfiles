<!-- Context: core/navigation | Priority: critical | Version: 1.1 | Updated: 2026-02-23 -->
...
├── project-intelligence/   # Project-specific context (business & technical)
└── system-builder-templates # System builder templates and patterns
```
...
| **Project context** | `project-intelligence/technical-domain.md` |
...
**project-intelligence/** - Project-specific context → `project-intelligence/navigation.md`
**system-builder-templates/** - System builder patterns → `system-builder-templates/navigation.md`
