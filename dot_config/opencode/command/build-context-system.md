...
<execute_routing>
<!-- Note: system-builder is not a single subagent but contains multiple specialized subagents -->
<!-- The command execution needs to orchestrate these subagents appropriately -->

<route to="subagents/system-builder/domain-analyzer" when="domain_unclear_or_complex">
<subagent_type>subagents/system-builder/domain-analyzer</subagent_type>
...
<!-- For generation, we need to orchestrate multiple system-builder subagents -->
<!-- Order: DomainAnalyzer → WorkflowDesigner → ContextOrganizer -->
<orchestration>
<step_1 route="subagents/system-builder/domain-analyzer">
Analyze domain and suggest agent specializations
</step_1>
<step_2 route="subagents/system-builder/workflow-designer">
Design workflows based on domain analysis
</step_2>
<step_3 route="subagents/system-builder/context-organizer">
Generate context files and structure
</step_3>
</orchestration>
</execute_routing>
</routing_intelligence>
