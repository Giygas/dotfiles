...
PanelWindow {
    ...
    margins { top: Math.round(5 * scaleFactor); left: 0; right: 0 }
    implicitHeight: Math.round(26 * scaleFactor)
    color: "transparent"
    ...
    property int notchH: Math.round(26 * scaleFactor)
    property int notchR: Math.round(13 * scaleFactor)
    property int notchPad: Math.round(10 * scaleFactor)
    property int notchGap: Math.round(6 * scaleFactor)
    ...
    // ── Notch: fully rounded floating pill ──
    component Notch: Item {
        ...
        Rectangle {
            ...
            anchors.topMargin: Math.round(4 * bar.scaleFactor)
            width: tooltipText.implicitWidth + Math.round(16 * bar.scaleFactor)
            height: tooltipText.implicitHeight + Math.round(8 * bar.scaleFactor)
            radius: Math.round(6 * bar.scaleFactor)
            ...
            Text {
                ...
                color: root.walForeground
                                font.pixelSize: Math.round(10 * bar.scaleFactor)
    ...
    Item {
        ...
        // Detect screen scale (Screen attached property is available on Items)
        property real screenScale: Screen.height / 1080
        onScreenScaleChanged: {
            if (screenScale > 0 && isFinite(screenScale)) bar.scaleFactor = screenScale
        }
        ...
        Row {
            ...
            anchors.leftMargin: bar.notchGap
            height: bar.notchH
            spacing: bar.notchGap

            // ── Apps / Wallpapers ──
            Notch {
                width: Math.round(40 * bar.scaleFactor)
                ...
                Item {
                    ...
                    Text {
                        ...
                        font.pixelSize: Math.round(14 * bar.scaleFactor)
                        font.family: "JetBrainsMono Nerd Font"
                    }
                }
            ...
            // ── Clock ──
            Notch {
                width: clockLabel.implicitWidth + bar.notchPad * 2
                ...
                Item {
                    ...
                    Text {
                        ...
                        font.pixelSize: Math.round(11 * bar.scaleFactor)
                        font.bold: true
                        font.family: "JetBrainsMono Nerd Font"
                    }
                }
            ...
            Notch {
                id: workspacesNotch
                width: wsContainer.width + bar.notchPad * 2
                ...
                Item {
                    ...
                    Item {
                        ...
                        anchors.centerIn: parent
                        width: wsRow.width
                        height: Math.round(20 * bar.scaleFactor)

                        Rectangle {
                            id: wsHighlight
                            height: Math.round(20 * bar.scaleFactor)
                            radius: Math.round(10 * bar.scaleFactor)

                            property real targetX: 0
                            property real targetWidth: Math.round(30 * bar.scaleFactor)
                        ...
                        Row {
                            id: wsRow
                            anchors.centerIn: parent
                            spacing: Math.round(2 * bar.scaleFactor)
                            ...
                            Repeater {
                                ...
                                delegate: Item {
                                    ...
                                    width: Math.max(wsText.implicitWidth + Math.round(8 * bar.scaleFactor), Math.round(24 * bar.scaleFactor))
                                    height: Math.round(20 * bar.scaleFactor)
        ...
        Notch {
            anchors.horizontalCenter: parent.horizontalCenter
            anchors.top: parent.top
            width: bar.mediaText !== "" ? mediaContent.width + bar.notchPad * 2 : 0
            ...
            Item {
                ...
                Column {
                    ...
                    Row {
                        anchors.horizontalCenter: parent.horizontalCenter
                        spacing: Math.round(10 * bar.scaleFactor)

                        Item {
                            width: cavaRow.width
                            height: Math.round(16 * bar.scaleFactor)
                            ...
                            Row {
                                ...
                                Repeater {
                                    ...
                                    Rectangle {
                                        width: Math.round(3 * bar.scaleFactor)
                                        height: Math.max(Math.round(3 * bar.scaleFactor), bar.cavaValues[index] * Math.round(16 * bar.scaleFactor))
                                        radius: Math.round(1.5 * bar.scaleFactor)
                                        anchors.verticalCenter: parent.verticalCenter
                                        color: root.walColor5
                                        antialiasing: true
                    ...
                    Rectangle {
                        ...
                        height: Math.round(3 * bar.scaleFactor)
                        radius: Math.round(2 * bar.scaleFactor)
        ...
        Row {
            ...
            anchors.top: parent.top
            anchors.rightMargin: bar.notchGap
            height: bar.notchH
            spacing: bar.notchGap

            // ── Battery ──
            Notch {
                width: batteryRow.width + bar.notchPad * 2
                ...
                Item {
                    ...
                    Row {
                        ...
                        Item {
                            width: Math.round(24 * bar.scaleFactor)
                            height: Math.round(14 * bar.scaleFactor)
                            anchors.verticalCenter: parent.verticalCenter
                            ...
                            Rectangle {
                                ...
                                anchors.left: parent.left
                                anchors.verticalCenter: parent.verticalCenter
                                width: Math.round(20 * bar.scaleFactor)
                                height: Math.round(12 * bar.scaleFactor)
                                radius: Math.round(4 * bar.scaleFactor)
                                color: "transparent"
                                border.width: bar.batteryPercent >= 100 ? 0 : Math.round(2 * bar.scaleFactor)
                                border.color: {
                                ...
                                Rectangle {
                                    id: batteryFill
                                    anchors.left: parent.left
                                    anchors.leftMargin: bar.batteryPercent >= 100 ? 0 : Math.round(2 * bar.scaleFactor)
                                    anchors.verticalCenter: parent.verticalCenter
                                    width: {
                                        if (bar.batteryPercent >= 100) return parent.width
                                        var inset = Math.round(5 * bar.scaleFactor)
                                        var base = Math.max(0, (parent.width - inset) * bar.batteryPercent / 100)
                                        if (bar.batteryCharging) {
                                            var extra = (parent.width - inset - base) * bar.chargingFillAnim * 0.3
                                            return base + extra
                                        }
                                        return base
                                    }
                                    height: bar.batteryPercent >= 100 ? parent.height : parent.height - Math.round(4 * bar.scaleFactor)
                                    radius: bar.batteryPercent >= 100 ? Math.round(4 * bar.scaleFactor) : Math.round(2 * bar.scaleFactor)
                                    color: {
                                        if (bar.batteryClass === "charging") return root.walColor2
                                        if (bar.batteryClass === "critical") return root.walColor1
                                        if (bar.batteryClass === "warning") return root.walColor4
                            ...
                            Rectangle {
                                ...
                                anchors.leftMargin: Math.round(1 * bar.scaleFactor)
                                anchors.verticalCenter: parent.verticalCenter
                                width: Math.round(2 * bar.scaleFactor)
                                height: Math.round(6 * bar.scaleFactor)
                                radius: Math.round(1 * bar.scaleFactor)
                            ...
                            Text {
                                ...
                                font.pixelSize: Math.round(7 * bar.scaleFactor)
                                font.family: "JetBrainsMono Nerd Font"
                            ...
                            Text {
                                ...
                                text: "󰄬"
                                color: root.walBackground
                                font.pixelSize: Math.round(8 * bar.scaleFactor)
                                font.family: "JetBrainsMono Nerd Font"
                                visible: bar.batteryPercent >= 100
                            }
                        }
            ...
            // ── Volume ──
            Notch {
                width: volumeLabel.implicitWidth + bar.notchPad * 2
            ...
            // ── Network ──
            Notch {
                width: networkRow.width + bar.notchPad * 2
                ...
                Item {
                    ...
                    Row {
                        ...
                        Text {
                            ...
                            font.pixelSize: Math.round(13 * bar.scaleFactor)
                            font.family: "JetBrainsMono Nerd Font"
